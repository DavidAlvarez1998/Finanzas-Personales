...
import { updateUserCurrencies } from '@/app/actions/currencies'
...
export function CurrencyPicker({ selected, onClose }: Props) {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-200/60 dark:border-zinc-800 shrink-0">
          <h2 className="text-base font-bold text-zinc-950 dark:text-white">Monedas</h2>
          <button
            onClick={onClose}
