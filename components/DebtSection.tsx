            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-1">
                  <button
                    onClick={() => openEdit(d)}
                    className="rounded px-2 py-1 text-xs text-zinc-500 hover:bg-zinc-200 hover:text-zinc-900 transition-colors dark:hover:bg-zinc-700 dark:hover:text-white"
                  >
                    Editar
                  </button>
                  <button
                    onClick={() => setDeletingId(d.id)}
                    className="rounded px-2 py-1 text-xs text-zinc-500 hover:bg-rose-100/80 hover:text-rose-600 transition-colors dark:hover:bg-rose-900/50 dark:hover:text-rose-400"
                  >
                    Eliminar
                  </button>
                </div>
