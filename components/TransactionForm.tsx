...
export function TransactionForm({ onSave, onClose, editing, initialType = 'expense' }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm px-4 pb-4 sm:pb-0 dark:bg-black/60">
      <div className="w-full max-w-md rounded-2xl border border-zinc-200/60 bg-white p-6 shadow-2xl max-h-[90svh] overflow-y-auto dark:border-zinc-700/50 dark:bg-zinc-900">
