                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-center gap-1">
                      <button
                        ...
                        disabled={isPending}
                        title="Editar"
                        className={`rounded-md p-1.5 text-zinc-400 hover:bg-zinc-200 hover:text-zinc-900 transition-colors dark:hover:bg-zinc-700 dark:hover:text-white ${isPending ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
                      ...
                      <button
                        ...
                        disabled={isPending}
                        title="Eliminar"
                        className={`rounded-md p-1.5 text-zinc-400 hover:bg-rose-100/80 hover:text-rose-600 transition-colors dark:hover:bg-rose-900/50 dark:hover:text-rose-400 ${isPending ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {paginated.length === 0 ? (
          ...
          paginated.map(t => (
            <div key={t.id} className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <div className="mt-2 flex justify-end gap-1 border-t border-zinc-200 pt-2 dark:border-zinc-800">
                <button
                  onClick={() => onEdit(t)}
                  disabled={isPending}
                  title="Editar"
